    ...
    <div x-data="LivewireUIModal()" x-on:close.stop="setShowPropertyTo(false)"
        ...
        <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-10 text-center sm:block sm:p-0">
            ...
            <div x-show="show && showActiveComponent" x-transition:enter="ease-out duration-300"
                ...
                class="inline-block w-full overflow-hidden text-left align-middle transition-all transform bg-gray-800 rounded-lg shadow-xl sm:my-8 sm:align-middle sm:w-full"
