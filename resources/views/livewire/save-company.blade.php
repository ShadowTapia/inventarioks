    ...
    <x-slot name="content">
        ...
        <form wire:submit.prevent="submit">
            ...
            <div class="colspan-6 sm:col-span-4">
                ...
                <x-bladewind.input id="url" wire:model.lazy="url" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600"/>
                <x-input-error for="url" class="mt-2"/>
            </div>
            {{-- Teléfono --}}
            <div class="colspan-6 sm:col-span-4">
                <x-label for="phone" value="{{ __('Teléfono Compañía') }}"/>
                <x-bladewind.input id="phone" wire:model.lazy="phone" numeric="true" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600"/>
