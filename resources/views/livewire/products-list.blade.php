                ...
                <tbody>
                    @foreach ($prtlist as $prt )
                        <tr>
                            ...
                            <td class="p-3 border">
                                <x-a-button id="addDevice" title="Agregar Dispositivo" class="mr-2 p-sm-button bg-violet-800 hover:bg-violet-600 focus:outline-none focus:ring-2 focus:ring-violet-600" href="{{ route('devi.create',$prt->id) }}">
