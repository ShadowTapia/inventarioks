<x-fondo-card>
    ...
    <x-slot name="content">
        ...
        <div class="flex flex-row mt-1">
                ...
                <div class="flex-initial items-center pl-2 pt-2">
                ...
                <div class="flex-auto content-end w-32 right-3" style="padding-left: 60%">
                    <x-a-button id="printDeviceCodebar" title="Imprimir" class="p-1 bg-sky-800  hover:bg-sky-600 focus:ring-offset-2 right-1 focus:ring-2 focus:ring-sky-600">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
            ...
            <table class="w-full mt-3 table-auto">
                <thead class="bg-sky-900">
                    <tr>
                        ...
                        <td class="p-3 border w-40">Acción</td>
                    </tr>
                </thead>
                <tbody>
